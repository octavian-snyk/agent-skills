...
Local setup notes for the `guided-experience-service-technical-analysis` skill.

## Local Defaults File

Use this file for non-secret local defaults for technical analysis and local debugging workflows.
...
When an artifact is provided, read it first and reuse its links, assumptions, prior plan, and open questions as investigation anchors, then validate findings from current code and test evidence.
